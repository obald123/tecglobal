...
const word = "TEC-GLOBAL";

const sideImages = [
  {
    src: "https://images.unsplash.com/photo-1621905251189-08b45249ff53?q=80&w=1000",
    alt: "Electrical switchgear installation",
    position: "left",
    span: 1,
  },
  {
      ...
      <div className="sticky top-0 h-screen overflow-hidden">
        <div className="flex h-full w-full items-center justify-center">
          ...
          >
            ...
            >
              <Image
                src="https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?q=80&w=2000"
              ...
              >
                <h1 className="w-full text-[13vw] font-medium leading-[0.8] tracking-tighter text-white whitespace-nowrap">
