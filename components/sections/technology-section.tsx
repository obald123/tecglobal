...
const sideImages = [
  ...
  {
    src: "https://images.unsplash.com/photo-1580894894513-541e068a3e2b?q=80&w=1000",
  ...
  },
  {
    ...
    alt: "Modern office building Rwanda",
    position: "right",
    span: 1,
  },
  {
...
export function TechnologySection() {
  ...
  const descriptionText = "Tec-Global partners with the world's leading electrical brands — ABB, Schneider Electric, Siemens, Fluke, and Hototech — to deliver certified, high-performance equipment to businesses across Rwanda. Every product we supply meets international quality standards, backed by our expert installation and maintenance teams.";
      ...
      <div className="sticky top-0 h-screen overflow-hidden">
        <div className="flex h-full w-full items-center justify-center">
          ...
          >
            ...
            >
              <Image
                src="https://images.unsplash.com/photo-1621905251189-08b45249ff53?q=80&w=2000"
              ...
              >
                <h2 className="max-w-3xl font-medium leading-tight tracking-tight text-white md:text-5xl lg:text-7xl text-5xl">
                  {["Precision.", "Quality.", "Trust."].map((word, index) => {
