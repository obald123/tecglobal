        ...
        <div className="sticky top-0 h-screen flex items-center justify-center">
          <div className="relative w-full">
            ...
            <div className="relative z-10 grid grid-cols-1 gap-4 px-6 md:grid-cols-2 md:px-12 lg:px-20">
              ...
              >
                <Image
                  src="https://images.unsplash.com/photo-1581092162384-8987c1d64718?q=80&w=1000"
                  alt="Electrical equipment supply warehouse"
                  fill
              ...
              >
                <Image
                  ...
                  alt="Electrical installation on site"
                  fill
                  className="object-cover"
                />
                <div className="absolute bottom-6 left-6">
      ...
      <div className="px-6 py-20 md:px-12 md:py-28 lg:px-20 lg:py-36 lg:pb-14">
        <div className="text-center">
          ...
          <p className="mt-8 leading-relaxed text-muted-foreground text-3xl text-center">
            Tec-Global delivers end-to-end electrical solutions — from sourcing premium equipment
            to on-site installation and long-term maintenance, tailored for each client.
          </p>
        </div>
      </div>
    </section>
